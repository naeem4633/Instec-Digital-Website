  ...
  return (
    <section className='flex flex-col pb-8 space-y-8 items-center min-h-[100vh] w-full text-black'>
        ...
        <div className='w-full flex flex-col space-y-4 p-8'>
            <p className='w-3/4 mx-auto text-3xl text-center font-semibold'>Business Continuity</p>
            <div className='w-1/2 mx-auto border border-gray-200'></div>
            <p className='w-3/4 mx-auto text-xl text-center'>You can turn to Instec for revitalizing your Business Continuity and Disaster Recovery Plans. Instec has the necessary 
            ...
            <p className='w-3/4 mx-auto text-xl text-center'>We combine our resilience experience, technology know-how, and industry knowledge to design and implement continuity 
            ...
            <p className='w-3/4 mx-auto text-xl text-center'>We are equally adept at formulating Business Continuity strategies growing out of Enterprise Risk and translating 
            Business Continuity into meaningful and actionable Disaster Recovery Plans.</p>
        </div>
        <div className='w-3/4 p-16 color-secondary items-center rounded drop-shadow-2xl tracking-wider'>
            <div className='mx-auto w-3/4 flex flex-col justify-start items-start text-white space-y-12'>
                <p className='w-full text-3xl font-semibold text-center'>Why INSTEC?</p>
                <div className='space-y-6 first-group'>
                    <div className='flex flex-col space-y-8 '>
                        <p className='text-3xl font-semibold'>Our Core Differentiating Factors</p>
                        <p className='text-xl font-semibold'>Expertise</p>
                    </div>
                    <div>
                        <p className='text-lg text-left'>Our consultants have 10+ years of experience in the field. This gives us enough depth to address your most 
                ...
                <div className='space-y-6 first-group'>
                    <div className='flex flex-col space-y-2'>
                        <p className='text-xl font-semibold'>Technology Partnerships</p>
                    </div>
                    <div>
                        <p className='text-lg text-left'>Many of our customers want not only a consultancy that can provide services as it relates to program management, 
                        ...
                        <p className='text-lg text-left'>Instec has partnerships with key technology vendors such as Amazon Web Services, Microsoft, Oracle and Vmware. 
                ...
                <div className='space-y-6 first-group'>
                    <div className='flex flex-col space-y-2'>
                        <p className='text-xl font-semibold'>Certification, Audit and Assessment Services</p>
                    </div>
                    <div>
                        <p className='text-lg text-left'>Instec offers complete range of audit and assessment services for your internal or external audit requirements. 
        ...
        <div className='w-3/4 flex flex-col mx-auto space-y-[20vh] p-8 text-white'>
            ...
            <div className='w-full p-16 bg-red-800 items-center rounded drop-shadow-2xl tracking-wider'>
                <div className='w-full flex flex-col justify-start items-start space-y-12'>
                    <div className='space-y-6 second-group'>
                        <div className='flex flex-col text-white space-y-8'>
                            <p className='text-3xl text-center font-semibold'>Consulting Services</p>
                            <p className='text-xl font-semibold'>Business impact analysis, to catalog your critical assets and processes</p>
                        </div>
                        <div className='w-full'>
                            <p className='text-lg text-left'>Instec can help you complete a BIA across a globally distributed enterprise using our proven methodology 
                    ...
                    <div className='space-y-6 second-group'>
                        <div className='flex flex-col text-white space-y-2'>
                            <p className='text-xl font-semibold'>Risk assessments, to identify and measure potential disruptions</p>
                        </div>
                        <div className='w-full'>
                            <p className='text-lg text-left'>Instec will help you in identifying, analyzing, and evaluating the risks to your business in a structured 
                    ...
                    <div className='space-y-6 second-group'>
                        <div className='flex flex-col text-white space-y-2'>
                            <p className='text-xl font-semibold'>Strategy and plan development, to align efforts with objectives</p>
                        </div>
                        <div className='w-full'>
                            <p className='text-lg text-left'>Once you understand your business requirements, dependencies, and most probable, high-impact risks through
                    ...
                    <div className='space-y-6 second-group'>
                        <div className='flex flex-col text-white space-y-2'>
                            <p className='text-xl font-semibold'>Testing, to provide assurance your plan will function</p>
                        </div>
                        <div className='w-full'>
                            <p className='text-lg text-left'>Without testing your plans are useless. Testing helps you validate your capabilities and ensure that everyone is 
                    ...
                    <div className='space-y-6 second-group'>
                        <div className='flex flex-col text-white space-y-2'>
                            <p className='text-xl font-semibold'>Maintenance and ongoing support, to account for changes in the business and risk profile</p>
                        </div>
                        <div className='w-full'>
                            <p className='text-lg text-left'>BC planning is not a one-time event, it's an ongoing program. You will need to regularly update BIAs and risk assessments, 
            ...
            <div className='w-full flex flex-row p-16 bg-red-800 items-center rounded drop-shadow-2xl tracking-wider'>
                <div className='w-1/4 flex flex-col items-center space-y-6'>
                    <img className='w-20 h-20' src='../static/images/customer-service.png'></img>
                </div>
                <div className='w-3/4 flex flex-col justify-start space-y-6 items-start'>
                    <p className='text-3xl font-semibold text-white'>Other Services</p>
                    <div className='w-3/4'>
