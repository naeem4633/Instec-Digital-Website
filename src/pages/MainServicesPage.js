    ...
    <section className='flex flex-col pb-8 space-y-12 items-center min-h-[100vh] w-full text-black bg-gray-100'>
        ...
        <div className='w-full h-[100vh]'>
          ...
          <div className='mx-auto space-x-52 flex flex-row justify-center items-center w-1/2 -translate-y-[90vh]'>
            <div className='flex flex-col space-y-4'>
                ...
                <Link to={'/services-details'} className='w-3/4 p-3 text-white bg-red-800 font-semibold hover:bg-red-950 rounded transitition-all duration-200'>
        ...
        <div className='w-full h-[50vh]'>
            <div className='mx-auto h-full w-3/4 flex flex-row items-center justify-center space-x-12'>
                <div className='p-16 h-full w-1/2'>
                    <img className='rounded drop-shadow-lg' src='../static/images/business-cont.jpg'></img>
                </div>
                <div className='h-3/4 w-1/2 p-4 flex flex-col space-y-8 items-start'>
                    <div className='w-3/4 flex flex-col space-y-8'>
                        <p className='text-2xl font-semibold tracking-wide'>Fight evil alongside the cyber security titans</p>
                        <div className='flex flex-col space-y-4'>
                            <p>Cyber security incidents require diligent preparation, rapid action and critical asset protection. INSTEC Consultants help organizations get
                                 ...
                                 <button className='drop-shadow-xl w-1/3 p-3 text-white bg-red-800 font-semibold hover:bg-red-900 rounded transitition-all duration-200'>
                                    <p className='text-center'>View all services</p>
                                </button>
        ...
        <div className='w-full min-h-[40vh] flex flex-col space-y-12'>
            <div className='mx-auto w-3/4 flex flex-row items-center space-x-12 justify-evenly'>
                <div className='flex flex-col items-center space-y-4'>
                    <p className='text-3xl font-semibold'>INSTEC Consulting</p>
                    <p>Most frequently publicly named incident response provider.</p>
                </div>
                <div className='flex flex-col items-center space-y-4'>
                    <p className='text-3xl font-semibold'>Fortune 100</p>
                    <p>More than 75% of Fortune 100 companies rely on INSTEC services.</p>
                </div>
            </div>
            <div className='mx-auto w-3/4 grid grid-cols-3 gap-12 p-16'>
                <div className='w-80 h-96 flex flex-col border bg-white p-8 space-y-4'>
            ...
            <div className='w-3/4 mx-auto px-8'>
                <div className='w-3/4 mx-auto p-12 flex flex-col space-y-4 bg-white'>
                    <p className='text-3xl font-semibold'>Transform your cyber defense operations</p>
            ...
            <div className='w-3/4 mx-auto px-8'>
                <div className='w-1/2 mx-auto p-12 flex flex-col space-y-6 items-center'>
                    <p className='text-3xl font-semibold'>Address the challenges your business faces</p>
                    <button className='flex p-3 w-fit bg-red-800 hover:bg-red-900 space-x-4 items-center rounded'>
            ...
            <div className='mx-auto w-3/4 grid grid-cols-1'>
                <div className='flex flex-row justify-evenly space-x-16'>
                    <div className='w-1/3 p-12 flex flex-col space-y-6 items-start'>
            ...
            <div className='w-3/4 mx-auto px-8'>
                <div className='w-1/2 mx-auto p-12 flex flex-col space-y-6 items-center'>
                    <p className='text-3xl font-semibold'>Frequently requested</p>
            ...
            <div className='w-3/4 mx-auto grid grid-cols-1'>
                <div className='flex flex-row justify-evenly'>
                    <div className='w-1/4 p-12 flex flex-col space-y-10 items-start'>
            ...
            <div className='mx-auto w-3/4 grid grid-cols-1'>
                <div className='flex flex-row justify-evenly space-x-16'>
                    <div className='w-96 h-72 flex flex-col border bg-white p-8 space-y-4'>
            ...
            <div className='w-full h-[50vh]'>
                <div className='mx-auto h-full w-3/4 flex flex-row items-center justify-center space-x-12'>
                    ...
                    <div className='h-3/4 w-1/2 p-4 flex flex-col space-y-8 items-start'>
                        <div className='w-3/4 flex flex-col space-y-8'>
                            <p className='text-2xl font-semibold tracking-wide'>Why choose INSTEC Consulting?</p>
                            <div className='flex flex-col space-y-4'>
                                ...
                                <p>Cyber security incidents require diligent preparation, rapid action and critical asset protection. INSTEC Consultants help organizations get
                                    back to business after a security incident. They apply their frontline expertise to help organizations transform their cyber defense capabilities 
                                    to mitigate threats and reduce business risk - before, during and after an incident.</p>
                                <button className='flex flex-row items-center justify-evenly drop-shadow-xl w-3/4 p-3 text-white bg-red-800 font-semibold hover:bg-red-900 rounded transitition-all duration-200'>
            ...
            <div className='w-full min-h-[50vh]'>
                <img className='rounded mx-auto w-3/5 h-80' src='../static/images/gradient-2.png'></img>
                <div className='mx-auto h-full w-1/2 flex flex-row items-center justify-center space-x-12 -translate-y-[20vh] text-white'>
                    <div className='w-full flex flex-row justify-between'>
                        ...
                        <div className='w-full flex flex-col space-y-4 items-center'>
                            ...
                            <button className='flex flex-row items-center justify-start space-x-3 drop-shadow-xl w-3/4 p-4 text-white bg-red-800 font-semibold hover:bg-red-900 rounded transitition-all duration-200'>
