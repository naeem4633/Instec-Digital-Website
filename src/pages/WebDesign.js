        ...
        <div className='w-full h-[100vh]'>
          ...
          <div className='mx-auto space-x-52 flex flex-row justify-center items-center w-1/2 -translate-y-[90vh]'>
            <div className='flex flex-col heading items-start'>
                <p className='text-white text-6xl font-bold '>Web Design &</p>
                <p className='text-6xl font-bold text-red-800'>Development</p> 
            </div>
            <img className='' src='../static/images/first.png'></img>
          </div>
        </div>
        <div className='w-full flex flex-col space-y-4 p-8'>
            <p className='w-3/4 mx-auto text-3xl text-center font-semibold'>Web Design & Development</p>
            <div className='mx-auto w-1/2 border border-gray-200'></div>
            <p className='w-3/4 mx-auto text-xl text-center'>Your website is a gateway to your brand - a critical communication channel for your audience, 
        ...
        <div className='w-3/4 flex flex-col mx-auto space-y-[20vh] p-8 text-white'>
            <div className='w-full flex flex-row p-16 bg-red-800 items-center rounded drop-shadow-2xl tracking-wider'>
                <div className='w-1/4 flex flex-col items-center space-y-6'>
                    <img className='w-20 h-20' src='../static/images/web-dev.png'></img>
                </div>
                <div className='w-3/4 flex flex-col justify-start space-y-6 items-start'>
                    <p className='text-3xl font-semibold text-white'>Strategic Web Development</p>
                    <div className='w-3/4  first-group'>
                        <p className='text-lg text-left'>Your website is a gateway to your brand - a critical communication channel for your audience, and often a major contributor
